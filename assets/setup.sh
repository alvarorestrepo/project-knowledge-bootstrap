...
$(find "$REPO_ROOT" -name "AGENTS.md" -not -path "*/node_modules/*" -not -path "*/.git/*" -not -path "*/vendor/*" -not -path "*/.next/*" -not -path "*/dist/*" 2>/dev/null)
EOF
...
echo ""
echo -e "${BOLD}AI Skills Setup — $PROJECT_NAME${NC}"
echo "========================================"
echo ""
